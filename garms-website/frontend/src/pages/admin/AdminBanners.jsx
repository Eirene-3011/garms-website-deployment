...
export default function AdminBanners() {
  ...
  const [form, setForm] = useState({ caption: '', sort_order: 0 });
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      setForm({ caption: '', sort_order: 0 }); setFile(null); setEditId(null);
      load();
  ...
  const handleEdit = (b) => {
    setEditId(b.id); setForm({ caption: b.caption || '', sort_order: b.sort_order || 0 });
        ...
        <div className="admin-card">
          ...
          <form onSubmit={handleSave}>
            ...
            <div className="form-actions">
              ...
              {editId && <button type="button" className="btn btn-ghost" onClick={() => { setEditId(null); setForm({ caption: '', sort_order: 0 }); }}>Cancel</button>}
            </div>
          </form>
        </div>
